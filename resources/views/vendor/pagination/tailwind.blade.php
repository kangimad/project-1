                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm text-gray-500 bg-gray-300 border border-gray-00 cursor-default font-bold leading-5">{{ $page }}</span>
                                    </span>
                                @else
